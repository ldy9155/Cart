...
<link rel="stylesheet" type="text/css" href="/Cart/CartCSS/join.css">
<link rel="stylesheet" type="text/css" href="/Cart/CartCSS/user_style.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
<script>
	$(function() {
		$("a[class=btn_agreeJoin]").click(function(){
			if($("input#idChk").val()=='false'){
				alert('아이디 중복체크가 필요합니다.');
				$("input#id").focus();
				return;
			}
			if($("input#pwChk").val()=="false"){
				alert("비밀번호를 확인해주세요");
				$("input#pw").focus();
				return;
			}
		...
		$(".memberPolicy .viewPolicyBtn").on("click", function() {
			$("#policyView").show();
		});
		$("#policyView .viewCloseBtn").on("click", function() {
			$("#policyView").hide();
		});
		$(".memberProtect .viewPolicyBtn").on("click", function() {
			$("#ProtectView").show();
		});
		$("#ProtectView .viewCloseBtn").on("click", function() {
			$("#ProtectView").hide();
		});
		$(".joinFormBtn .btn_agreeJoin").on("click", function() {
			$("input[name='agreement']").val("Y");
			$("input[name='privercy']").val("Y");
		});
	...
	<center>
		...
		<div class="wrap" style="width: 1200px">
			<div class="fullsizeMargin">
				...
				<!-- 메인본문 디자인 : START -->
				<div class="wrapContent" style="width: 970px; margin-top: 30px">
					<form id="frm" name="frm" action="MemberAdd.do?cmd=MemberAdd" method="post">
						<input type="hidden" name="agreement" value="N">
						<input type="hidden" name="privercy" value="N">
						<div class="subpageTitle">회원가입</div>
						<div>
							<img src="/Cart/imges/join_yak_text.gif" alt="">
						</div>
						<div style="overflow: hidden;">
							<div class="" style="float: left; width: 100%;">
								<!-- 약관 입력폼 -->
								<div class="policyAgree">
									<!-- 약관확인/동의 버튼 -->
									<div class="memberPolicy">
										<div class="viewPolicyBtn" onmouseover="this.className='overPolicyBtn'" onmouseout="this.className='viewPolicyBtn'">
											회원약관
											<div style="float: right; font-weight: normal;">
												<a href="#">
													보기
													<img src="/Cart/imges/policy_btn_bg.gif" border="0" align="absmiddle" alt="">
												</a>
											</div>
										</div>
									</div>
									<div class="memberProtect">
										<div class="viewPolicyBtn" onmouseover="this.className='overPolicyBtn'" onmouseout="this.className='viewPolicyBtn'">
											개인정보취급방침
											<div style="float: right; font-weight: normal;">
												<a href="#">
									...
									<div id="policyView" class="policyView" style="display: none;">
										<div class="viewBox1">
											<div class="viewCloseBtn">
												<a href="#" style="font-size: 30px; line-height: 120%; text-decoration: none;">X</a>
											</div>
											<h4>회원가입 약관보기</h4>
											<div class="viewBox2">
												<p>인터넷 쇼핑몰 『 [SHOP] 사이버 몰』회원 약관</p>
												<p>
													제1조(목적)
													<br>
													이 약관은 [COMPANY] 회사(전자상거래 사업자)가 운영하는 [SHOP] 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
												</p>
									...
									<div id="ProtectView" class="policyView" style="display: none;">
										<div class="viewBox1">
											...
											<div class="viewBox2">
												...
												<p>
													ο 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산 구매 및 요금 결제
													<br>
													ο 회원 관리
													<br>
													&nbsp;&nbsp; 회원제 서비스 이용에 따른 본인확인, 개인 식별, 가입 의사 확인, 연령확인, 만14세 미만 아동
													<br>
												...
												<p>
													보존 항목 : 이름, 성별, 로그인ID, 비밀번호, 비밀번호 질문과 답변, 자택 전화번호, 자택 주소,
													<br>
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 휴대전화번호, 이메일, 회사전화번호
													<br>
													보존 근거 : 내부방침에 따라 별도 관리
													<br>
													보존 기간 : 회원가입을 탈퇴하거나 회원에서 제명된 때
												</p>
												<p>
													<br>
													그리고 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서 정한
													<br>
													일정한 기간 동안 회원정보를 보관합니다.
												</p>
												<p>ο 위 보유기간에도 불구하고 계속 보유하여야 할 필요가 있을 경우에는 귀하의 동의를 받겠습니다.</p>
												...
												<p>
													ο 파기절차
													<br>
													&nbsp;&nbsp; 회원님이 회원가입 등을 위해 입력하신 정보는 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우
													<br>
												...
												<p>ο 개인정보의 처리를 위탁하는 경우에는 미리 그 사실을 귀하에게 고지하겠습니다.</p>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="memberJoinForm">
									<div class="joinNotice">
										<ul>
											<li>
												-
												<span class="orangeFonts">*</span>
												는 필수입력 항목입니다.
											</li>
											<li>
												-
												<span class="orangeFonts">*</span>
												아이디/이메일 중복체크 후 반드시 [사용하기] 버튼을 클릭해야만 검색결과가 적용됩니다.
											</li>
										</ul>
									</div>

									<table border="0" cellpadding="0" cellspacing="0" width="100%" class="joinFormTbl">
										<colgroup>
											<col width="22%">
											<col width="30%">
											<col width="20%">
										...
										<tbody>
											<tr>
												<th>
													<span style="color: #F02800; font-weight: bold;">＊</span>
													아이디
												</th>
												<td colspan="3">
													<input type="hidden" name="idChk" id="idChk" value="false" size="20" maxlength="12" class="input">
													<input type="text" id="id" name="id" value="" maxlength="12" style="WIDTH: 150px;" class="input">
													<a href="#" class="joinBtn">아이디 중복체크</a>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="hidden" name="pwChk" id="pwChk" value="false" size="20" maxlength="12" class="input">
													<input type="password" id="pw" name="pw" value="" maxlength="20" style="WIDTH: 150px;" class="input">
												</td>
												<th>
													<span style="color: #F02800; font-weight: bold;">＊</span>
													비밀번호 확인
												...
												<td>
													<input type="password" id="pw2" name="pw2" value="" maxlength="20" style="WIDTH: 150px;" class="input">
												</td>
											</tr>
											<tr>
												<th>
												...
												<td colspan="3">
													<input type="text" name="email" value="" maxlength="100" style="WIDTH: 50%;" class="input">
												</td>
											</tr>
											<tr>
												<th>
												...
												<td colspan="3">
													<input type="text" name="name" value="" maxlength="15" style="WIDTH: 150px;" class="input">
												</td>
											</tr>
											<tr>
												<th>
												...
												<td colspan="3">
													<input type="text" maxlength="15" name="mobile" value="" style="WIDTH: 50%;" class="input">
													<span style="float: left; margin: 5px; font-size: 12px;">(입력 예 : 01012345678)</span>
												</td>
											</tr>
											...
											<tr>
												...
												<td colspan="3">
													<input type="text" name="birth" value="" maxlength="10" style="WIDTH: 150px;" class="input">
													<span style="float: left; margin: 5px; font-size: 12px;">(입력 예 : 2017-07-05)</span>
												</td>
											</tr>
										</tbody>
									</table>
									...
									<div style="margin-top: 15px; overflow: hidden;">
										<label style="cursor: pointer; font-size: 15px;">
											<input type="checkbox" name="news_mail_yn" class="formCheckbox" value="Y" checked="">
											<span style="float: left; margin: 2px 35px 2px 5px;">메일 수신여부</span>
										</label>
										<label style="cursor: pointer; font-size: 15px;">
											<input type="checkbox" name="news_sms_yn" class="formCheckbox" value="Y" checked="">
											<span style="float: left; margin: 2px 5px;">SMS 수신여부</span>
										</label>
									</div>
								</div>
							</div>
						...
						<div class="joinFormBtn">
							<a href="#" class="btn_agreeJoin"> 약관동의 후 회원가입 </a>
						</div>

						<!-- 개인정보 수집 및 이용안내 -->
						<table cellpadding="0" cellspacing="1" width="100%" class="privercyViewTable">
							<caption>· 개인정보 수집 및 이용 안내</caption>
							<colgroup>
								<col width="10%">
								<col width="10%">
								<col width="10%">
							...
							<tbody>
								...
								<tr>
									<td>필수정보</td>
									<td rowspan="2">회원가입 및 주문서</td>
									<td>서비스 이용 및 상담</td>
									<td>아이디, 비밀번호, 이메일, 이름, 휴대폰번호, 생년월일</td>
									<td>회원탈퇴 시 즉시 삭제. 단, 아이디로 사용되는 이메일은 부정사용 및 중복가입 방지를 위해 탈퇴DB에서 6개월 후 삭제</td>
								</tr>
								<tr>
									<td>선택정보</td>
									<td>마케팅</td>
